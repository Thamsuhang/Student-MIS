...
<div class="form-group col-sm-6">
    {!! Form::label('Date registered', 'Date Registered:') !!}
    {!! Form::date('Date registered', null, ['class' => 'form-control','id'=>'Date registered']) !!}
</div>

@section('scripts')
    <script type="text/javascript">
        $('#Date registered').datetimepicker({
            format: 'YYYY-MM-DD HH:mm:ss',
            useCurrent: false
        })
    </script>
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('admisions.index') }}" class="btn btn-default">Cancel</a>
</div>
